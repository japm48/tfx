...
def resolve_exec_properties(
    node: proto_views.NodeProtoView) -> Dict[str, types.ExecPropertyTypes]:
...
def generate_resolved_info(
    metadata_handler: metadata.Metadata,
    node: proto_views.NodeProtoView) -> Optional[ResolvedInfo]:
...
def get_executions(
    metadata_handler: metadata.Metadata,
    node: proto_views.NodeProtoView) -> List[metadata_store_pb2.Execution]:
